        ...
        <Fragment>
             <section className={classes.main}>
                <div className={classes.main__box}>
                    <h1 className={classes.header__main}> Main Section Header</h1>
            ...
            <section className={classes.people}>
                <div  className={classes.people__box}>
                    <HomePerson img='../../../../images/the-father.jpg' title='the father'/>
                    <HomePerson img='../../../../images/the-actor.jpg' title='the actor'/>
                    <HomePerson img='../../../../images/the-nerd.jpg' title='the nerd'/>
                </div>
            </section>
        </Fragment>
